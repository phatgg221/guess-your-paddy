      ...
      <main className="flex-grow">
        ...
        <div className="py-20 bg-gradient-to-br from-crop-primary to-crop-primary/80 text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              <h2 className="text-xl font-medium mb-3 text-crop-secondary animate-fadeIn">Meet Our Team</h2>
              <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">THE LIEMS'</h1>
              <p className="text-lg opacity-90 mb-8 leading-relaxed">
                We're a passionate team of AI specialists dedicated to creating innovative solutions
                ...
                >
                  ...
                  <div className="flex space-x-3 items-center">
                    ...
                    <div className="flex space-x-2">
                      <a href="#" className="text-white hover:text-crop-secondary transition-colors">
        ...
        <div className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-8 text-crop-primary">Get in Touch</h2>
